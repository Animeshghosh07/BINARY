...
# Initialize Flask app and set the template folder to the current directory
    ...
    while True:
        ...
        if not success:
            ...
            if len(frame_buffer) == 16:
                ...
                # Decision: Display "Violence Detected" if `min_violence_frames` out of 10 predictions are above the threshold
